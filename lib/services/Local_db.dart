...
class LocalDb implements DatabaseInterface {
  ...
  Future<bool> saveUser(String u, String ph, {String? avatarUrl}) async {
    try {
      print('Attempting to save user: $u');
  ...
  Future<bool> setCurrentUser(String username) async {
    try {
      ...
      print('Current user set to: $username, result: $result');
      return result;
    } catch (e) {
  ...
  Future<String?> getCurrentUser() async {
    try {
      ...
      print('Current user retrieved: $user');
      return user;
    } catch (e) {
  ...
  Future<bool> clearCurrentUser() async {
    try {
      ...
      print('Current user cleared, result: $result');
      return result;
    } catch (e) {
